...
class NodePrivilegedService(object):
    ...
    @staticmethod
    def ChainGovernorDropPendingVAA(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def ChainGovernorReleasePendingVAA(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def ChainGovernorResetReleaseTimer(
        request,
        target,
        options=(),
        channel_credentials=None,

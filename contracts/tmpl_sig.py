...
class TmplSig:
    ...
    def __init__(self):
        ...
        self.map = {
            ...
            "version": 6,
            "source": "",
            "bytecode": "BiABAYEASIAASDEQgQYSRDEZIhJEMRiBABJEMSCAABJEMQGBABJEMQkyAxJEMRUyAxJEIg==",
            "template_labels": {
            ...
            "label_map": {},
            "line_map": [
                0, 1, 4, 6, 7, 9, 10, 12, 14, 15, 16, 18, 19, 20, 21, 23, 25, 26,
                27, 29, 31, 32, 33, 35, 37, 38, 39, 41, 43, 44, 45, 47, 49, 50, 51,
            ],
        }
    ...
    def get_sig_tmpl(self):
        ...
        return compileTeal(
            program, mode=Mode.Signature, version=6, assembleConstants=True
        )
